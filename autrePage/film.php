...
<body>
	...
	<div id="fd_listeFilm" class="container-fluid">
		<section class="col-lg-8 col-md-8 col-sm-12 col-xs-12" style="margin:0px 0 40px 0;">
		...
		<section id="fd_tabeNeeded" class="col-lg-4 col-md-4 col-ms-6 col-xs-6" style="margin:0px 0 40px 0;">
	...
	<script type="text/javascript" src="../script/mini_script/displayDemo.js"></script>
</body>
</html>